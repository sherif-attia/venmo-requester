...
[![python](https://img.shields.io/badge/python-3.10%20%7C%20security-yellow?logo=python[![python](https://img.shields.io/badge/python-3.10%20%7C%20security-yellow?logo=python&logoColor=white)](https://devguide.python.org/versions/#full-chart)logoColor=white)](https://devguide.python.org/versions/#full-chart)
